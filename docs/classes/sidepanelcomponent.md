...
*Defined in [app/components/side-panel/side-panel.component.ts:15](https://github.com/WilliamRADFunk/cryptobot-interface/blob/0ee4bcc/src/app/components/side-panel/side-panel.component.ts#L15)*
